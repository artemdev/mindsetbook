// пример из https://codepen.io/danubevictoria/pen/WObGGQ
// личностный тест по книге "Гибкое сознание"

// вопросы теста
var prompts = [
  {
    prompt: "Моя вторая половинка должна",
    weight: -1,
    class: "group0"
  },
  {
  ...
  {
    prompt: "Когда вы чувствуете себя умным ?",
    weight: -1,
    class: "group2"
  },
  {
    prompt: "Что вы чувствуете когда ошибаетесь?",
    weight: -1,
    class: "group3"
  },
  {
...
var answers1 = [
  ...
  {
    value: "ставить меня на пьядестал",
    class: "choose_answer",
    weight: 0
  },
  {
    value: "толкать меня к совершенствованию 1",
    class: "choose_answer",
    weight: 1
  },
  {
    value: "поощрять меня осваивать новое",
    class: "choose_answer",
    weight: 1
  }
];
...
var answers2 = [
  {
    value: "море быстрых успехов и признаний",
    class: "choose_answer",
    weight: 0
  },
  {
    value: "массу вызовов и испытаний",
    class: "choose_answer",
    weight: 1
  },
  {
...
var answers3 = [
  {
    value: "когда я делаю что-то быстро и лучше всех",
    class: "choose_answer",
    weight: 0
  },
  {
    value: "когда я с трудом нахожу решение новой для меня задачи ",
    class: "choose_answer",
    weight: 1
  }
];
...
var answers4 = [
  ...
  {
    value: "радость от возможности научиться ",
    class: "choose_answer",
    weight: 1
  }
];
...
// подсвечиваем выбранный ранее ответ
...
Ambiverts exhibit both extroverted and introverted tendencies. This means that they generally enjoy being around people, but after a long time this will start to drain them. Similarly, they enjoy solitude and quiet, but not for too long. Ambiverts recharge their energy levels with a mixture of social interaction and alone time.";
  ...
  // прячем вопросы когда виден результат теста
  $("#quiz").addClass("hide");
  $("#submit-btn").addClass("hide");
  $("#retake-btn").removeClass("hide");
});

// Показываем снова вопросы теста если нажата кнопка "пройти еще раз"
